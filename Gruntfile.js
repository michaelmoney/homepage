module.exports = function(grunt) {
   ...
   var mozjpeg = require('imagemin-mozjpeg');
    ...
    // Main build task
    grunt.registerTask('build', ['jslint', 'uglify', 'pngmin', 'imagemin', 'copy', 'processhtml:build']);

    grunt.registerTask('default', ['jslint', 'concat_css', 'cssmin', 'uglify', 'imagemin', 'pngmin', 'copy', 'processhtml:build', 'concat_css']);
    grunt.registerTask('compress', ['imagemin']);
    grunt.registerTask('concatCSS', ['concat_css']);
    grunt.registerTask('css_min', ['cssmin']);
    grunt.registerTask('lint', ['jslint']);
    grunt.registerTask('cp', ['copy']);
    grunt.registerTask('png_min', ['pngmin']);
    grunt.registerTask('proc', ['processhtml:build']);
};
